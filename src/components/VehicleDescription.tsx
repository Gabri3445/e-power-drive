...
const VehicleDescription = (props: VehicleDescription) => {
  return (
    <div onClick={(e: React.MouseEvent<HTMLDivElement>) => {e.currentTarget.style.display = "none"}} className="w-screen h-screen absolute top-0 left-0 bg-black/[0.5]">
      <div className="overflow-auto w-[73.91%] h-[72.42%] absolute bg-white rounded-[21px] left-0 right-0 ml-auto mr-auto bottom-[23px]">
